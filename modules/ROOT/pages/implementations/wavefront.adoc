...
include::partial$install.adoc[leveloffset=+1]
...
* xref:#configuring-directly-to-wavefront[Directly to Wavefront]
* xref:#configuring-through-a-wavefront-proxy-sidecar[Through a Wavefront Proxy Sidecar]
...
xref:#wavefront-histograms[Wavefront Histograms], later in this section.
